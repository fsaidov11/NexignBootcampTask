...
public class CallBuilder implements BuildCall {
    private final DateTimeFormatter formatterToLocalDate = DateTimeFormatter.ofPattern("yyyyMMddHHmmss");
    private final DateTimeFormatter formatterToStringDate = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
